...
**[Install from the Chrome Web Store](https://chromewebstore.google.com/detail/igmljihkhepkngmgnlbcpbceehfonkhn)** — Edge Add-ons listing coming soon (or load unpacked, see below).
...
**[Chrome Web Store](https://chromewebstore.google.com/detail/igmljihkhepkngmgnlbcpbceehfonkhn)** (works in Chrome, Brave, and other Chromium browsers).
...
The companion site under `site/` is regenerated automatically every hour by the [site workflow](.github/workflows/site.yml), which queries Unity's public listing API and deploys to GitHub Pages.
